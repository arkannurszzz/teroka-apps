            ...
            <div className="flex justify-center sm:justify-start">
              <Link href="/" className="flex items-center group">
                ...
                <Image
                  ...
                  width={20}
                  height={20}
                  className="h-5 w-auto md:h-6 lg:h-7 transition-transform duration-150 ease-in-out group-hover:rotate-360 mx-1"
                />
                <span className="text-xl md:text-2xl font-bold tracking-tight leading-none text-[#000000]">
                  KA
                </span>
                  ...
                  <li>
                    <Link href="/chat" className="flex group justify-center sm:justify-start gap-1.5">
                      ...
                      <span className="relative flex w-2 h-2 -mr-2">
                        ...
                        <span className="relative inline-flex w-2 h-2 bg-[#D9302C] rounded-full" />
                      </span>
                    </Link>
                  </li>
                </ul>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <a href="mailto:support@teroka.id" className="flex items-center justify-center sm:justify-start gap-1.5 group">
                    ...
                    <span className="text-[#6b7280] transition group-hover:text-[#D9302C]">support@teroka.id</span>
                  </a>
                </li>
                <li>
